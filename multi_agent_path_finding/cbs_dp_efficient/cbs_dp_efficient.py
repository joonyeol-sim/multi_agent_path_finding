...
from multi_agent_path_finding.cbs_dp_efficient.ct_node import CTNode
...
class ConflictBasedSearchDPEfficient:
    def __init__(self, start_points: List[Point], goal_points: List[Point], env: Environment):
        ...
        self.env = env
        self.individual_planners: List[SpaceTimeAstarDP] = None
    ...
    def plan(self):
        ...
        while self.open_set:
            ...
            for agent_id in conflict.agent_ids:
                ...
                for constraint in new_node.constraints:
                    pruning_node = None
                    if type(constraint) == VertexConstraint:
                    ...
                    for closed_node in self.individual_planners[agent_id].closed_set:
                    ...
                    self.prune_successor(
                        pruning_node,
                        self.individual_planners[agent_id].open_set,
                        self.individual_planners[agent_id].closed_set,
                    )
